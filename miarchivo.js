...
//Inicio filter
let arrayJugadores = [
    { nombre: "Erling Haaland", edad: 22, estatura: 1.94, nacionalidad: "Noruego", equipo: "Manchester City", posicion: "Delantero centro", goles: 10, dorsal: 9},
    { nombre: "Aleksandar Mitrovic", edad: 27, estatura: 1.89, nacionalidad: "Serbio", equipo: "Fulham", posicion: "Delantero centro", goles: 6, dorsal: 9},
    { nombre: "Harry Kane", edad: 29, estatura: 1.88, nacionalidad: "Inglés", equipo: "Tottenham", posicion: "Delantero centro", goles: 5, dorsal: 10},
    { nombre: "Ivan Toney", edad: 26, estatura: 1.79, nacionalidad: "Inglés", equipo: "Brentford", posicion: "Delantero centro", goles: 5, dorsal: 17},
    { nombre: "Wilfried Zaha", edad: 29, estatura: 1.80, nacionalidad: "Marfileño", equipo: "Crystal Palace", posicion: "Extremo izquierdo", goles: 4, dorsal: 11},
];
...
listaJugadores.forEach((jugador) => {
    ...
    column.innerHTML = `
        <div class="card">
            <div class="card-body">
                <p class="card-text">Nombre: <b>${jugador.nombre}</b></p>
                <p class="card-text">Edad: <b>${jugador.edad}</b></p>
                <p class="card-text">Estatura: <b>${jugador.estatura}</b></p>
                <p class="card-text">Nacionalidad: <b>${jugador.nacionalidad}</b></p>
                <p class="card-text">Equipo: <b>${jugador.equipo}</b></p>
                <p class="card-text">Posición: <b>${jugador.posicion}</b></p>
                <p class="card-text">Cantidad goles: <b>${jugador.goles}</b></p>
                <p class="card-text">Dorsal: <b>${jugador.dorsal}</b></p>
            </div>
        </div>
    `
    contenedorJugadores.append(column)
});
//Termino Modificar en DOM